...
insert into TRANSACTION (amount, transaction_date, transaction_type) values (1500, '2023-01-01', 'DEPOSIT');
insert into TRANSACTION (amount, transaction_date, transaction_type) values (500, '2023-01-03', 'WITHDRAW');
insert into TRANSACTION (amount, transaction_date, transaction_type) values (100, '2023-01-08', 'WITHDRAW');
insert into TRANSACTION (amount, transaction_date, transaction_type) values (300, '2023-01-02', 'DEPOSIT');
insert into TRANSACTION (amount, transaction_date, transaction_type) values (250, '2023-01-05', 'WITHDRAW');
insert into TRANSACTION (amount, transaction_date, transaction_type) values (800, '2023-01-06', 'DEPOSIT');
insert into TRANSACTION (amount, transaction_date, transaction_type) values (600, '2023-01-03', 'WITHDRAW');
insert into TRANSACTION (amount, transaction_date, transaction_type) values (5000, '2023-01-05', 'DEPOSIT');
insert into TRANSACTION (amount, transaction_date, transaction_type) values (2500, '2023-01-10', 'DEPOSIT');
